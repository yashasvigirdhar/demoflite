...
public class Flitetest extends Activity implements TextToSpeech.OnInitListener {
	...
	public void onCreate(Bundle savedInstanceState) {
		 ...
		 * mycallback(); boolean
		 * result=mFliteEngine.setOnWordCompletedListener(fd);
		 * Log.v("in flite test", "should be true "+result);
		 * mFliteEngine.gettest(); Toast.makeText(Flitetest.this, "i am here",
